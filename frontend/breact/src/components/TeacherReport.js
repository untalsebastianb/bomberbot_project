// Component create report peer teacher
...
const TeacherReport = (props) => {
    /*
     * Create the component that displays the report for each teacher
     * Return: section teacher report
     */

    // consult the API to obtain the id through the cookie
